...
;Nie jestem pewien czy warto wprowadzić zmiany na stałe. Testy,
;które tutaj mam pokazują różne wyniki. Widać że jeżeli program bazuje
;na wielu podstawieniach jak w przypadku nwd to zmiana usprawnia program,
;ale na przykład przy programie z liczbą pierwszą nie jest to już takie pewne.
;Różnice są nieznaczne, a czasem wręcz usprawnienie spowalnia program.
